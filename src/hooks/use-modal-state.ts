...
type RouteSearch<TId extends keyof FileRoutesById> = InferFullSearchSchema<
  FileRoutesById[TId]
>
...
export type ModalStateOptions<
  TFrom extends RouteContext,
  TKey extends keyof RouteSearch<TFrom> & string,
> = {
  from?: TFrom
  paramName: TKey
...
function useModalState<
  TFrom extends RouteContext = '__root__',
  TKey extends keyof RouteSearch<TFrom> & string = keyof RouteSearch<TFrom> &
    string,
>({
  from: _from,
  paramName,
